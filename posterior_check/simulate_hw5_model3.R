...
simul_pars = data.frame(alpha_pos = rnorm(num_subjs, 0.20, 0.08), 
                        ...
                        beta = rnorm(num_subjs, 2.00, 0.70), subjID = 1:num_subjs)
...
# save alpha and beta
saveRDS(simul_pars, file="simul_pars4.rds")

# Write out data
write.table(all_data, file = "simul_data_hw5_model4.txt", row.names = F, col.names = TRUE, sep = '\t')
